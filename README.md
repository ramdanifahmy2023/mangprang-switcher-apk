...
Versi v0.3.5 native Android WebView dengan dynamic safe-area API 30+, display cutout handling, WebView viewport, dan bottom toolbar fix. Ini bukan Chrome Extension; ini APK terpisah supaya tim bisa switch toko Akulaku dari HP Android lewat akun Tracsh.
